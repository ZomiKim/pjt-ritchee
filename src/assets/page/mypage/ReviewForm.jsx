...
import { createReview, getHospitalList } from '../../../api/hospital_createreview';
...
function ReviewForm() {
  ...
  const { hospitalCode, hospitalName: HospitalName = '', a_id } = location.state || {};
      ...
      <div className="min-h-screen bg-light-02 myBg text-sm md:px-6 md:py-3 md:text-base lg:px-8 lg:py-4 lg:text-lg">
        <div className="container flex flex-col">
          ...
          <div className="pl-1 my-5 text-gray-500 w-full md:max-w-3xl mx-auto">
            <div className="container">· &nbsp; 방문 일자 &nbsp;: 2025-11-12</div>
          </div>

          <div className="container">
            <div className="w-full md:max-w-2xl mx-auto border border-main-01 p-5 rounded-[4px] mb-5 bg-white text-gray-200">
