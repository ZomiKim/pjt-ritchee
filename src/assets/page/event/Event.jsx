  ...
  const eventData = [
    {
      ...
      imgMobile: 'https://uosmaiisnppqgxbcbawc.supabase.co/storage/v1/object/public/images/tevent1.jpg',
    ...
    },
    {
      ...
      imgMobile: 'https://uosmaiisnppqgxbcbawc.supabase.co/storage/v1/object/public/images/tevent2.jpg',
    ...
    },
    {
      ...
      imgMobile: 'https://uosmaiisnppqgxbcbawc.supabase.co/storage/v1/object/public/images/pevent3.jpg',
    ...
    },
    {
      ...
      imgMobile: 'https://uosmaiisnppqgxbcbawc.supabase.co/storage/v1/object/public/images/pevent4.jpg',
    ...
    {
      eventId: 5,
      imgTb: 'https://uosmaiisnppqgxbcbawc.supabase.co/storage/v1/object/public/images/event5_2.jpg',
    },
  ];
              ...
              {item.Info && (
                <div className="container block md:hidden">
                  <div className="flex items-center gap-[1.28vw] mt-[2.87vh] mb-5 md:hidden">
                    ...
                    <h4 className="font-Pretendard text-deep" style={{ fontSize: 'clamp(20px, 3vw, 28px)' }}>
                      구로구 주민 이벤트
                    </h4>
                  </div>

                  <p className="mb-[2.87vh] font-Pretendard" style={eventTexts}>
                    구로구 주민 여러분을 위한 특별 치과 이벤트! 건강한 치아, 밝은 미소를 위한 무료 검진 및 스케일링
                    혜택을 만나보세요. 예약은 선착순! 지금 바로 신청하세요.
                  </p>
                </div>
              )}
            </div>
      ...
      <div className="hidden md:block xl:hidden myBg">
        <div className="overflow-hidden w-full md:h-[60vh] lg:h-[70vh]">
          <div onClick={() => selectClick(eventData[0].eventId)} className="w-full h-full cursor-pointer mb-6">
            <img src={eventData[0].imgTb} alt="img" className="w-full h-full object-cover" />
          </div>
        </div>
        ...
        {eventData[0].Info && (
          <div className="container mt-6">
            <div className="flex items-center gap-4 mt-[2.87vh] mb-4 ">
              ...
              <h4 className="font-Pretendard text-deep xl:text-7xl" style={{ fontSize: 'clamp(20px, 3vw, 28px)' }}>
                구로구 주민 이벤트
              </h4>
            </div>
